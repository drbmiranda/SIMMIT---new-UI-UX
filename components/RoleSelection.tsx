...
import homeAvatar from '../design-SIMMIT/figma-sections/02-home-screen/assets/avatar.png';
      ...
      <div className="rounded-3xl border border-white/70 bg-[radial-gradient(ellipse_at_top_left,#f8fafc_40%,#e3d1f7_62%,#d1f5e9_100%)] p-5 shadow-[0_24px_64px_rgba(116,28,217,0.16)]">
        <div className="flex flex-wrap items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <img src={homeAvatar} alt="Avatar" className="h-9 w-9 rounded-full border border-[#741cd9]/50" />
          </div>
        </div>

        <h2 className="mt-8 text-center font-title text-3xl text-[#020617] sm:text-4xl">Bom dia, Dr. B! Como posso ajudar você hoje?</h2>
      </div>
